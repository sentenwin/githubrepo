...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-demoapp-app-mobile.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-demoapp-app-mobile)

This repository contains the source code for the [demoapp](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.demoapp.app.mobile).

Please see the [issues](https://github.com.demoapp.app.mobile/com-demoapp-app-mobile/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about demoapp? Ask away on the [com-demoapp-app-mobile discussion forum](https://groups.google.com/forum/#!forum/com-demoapp-app-mobile).

<a href="https://play.google.com/store/apps/details?id=com.demoapp.app.mobile" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.demoapp.app.mobile__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.demoapp.app.mobile__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.demoapp.app.mobile.R__) will now be renamed
...
signed with a different key.  Manually uninstall demoapp from your device and
...
demoapp is a result of a template project I've developed over the years as well as
...
demoapp is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.demoapp.app.mobile/com-demoapp-app-mobile/contributors) on
...
[pull requests](https://github.com.demoapp.app.mobile/com-demoapp-app-mobile/pulls).
