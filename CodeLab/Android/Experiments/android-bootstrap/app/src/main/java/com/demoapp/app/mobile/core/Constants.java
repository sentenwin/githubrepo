...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.demoapp.app.mobile";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "demoapp";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.demoapp.app.mobile.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.demoapp.app.mobile.";
